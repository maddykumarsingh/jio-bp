    ...
    <body class="">
                ...
                <div class="container">
                         <div class="row">
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12 highlight-text">[ Drag on the image to solve puzzle ]</div>
...
timer();
            ...
            $(document).ready(function(){
                newPuzzle("https://myofficeengagements.com/liberty_amazing_race/images/jigsaw/j1.jpg");
            });

         function nextPuzzle(){
            newPuzzle("https://myofficeengagements.com/liberty_amazing_race/images/jigsaw/j2.jpg");
         }
        
        function newPuzzle(getNewImage){
            ...
            const opts = {};
            const image = (getURLParameter('image')) ? getURLParameter('image') : getNewImage;
...
document.addEventListener('DOMContentLoaded',function(){
    ...
    this.Puzzle = function(opts) {
        ...
        this.settings = {
            el             : null,
            image          : 'http://myofficeengagements.com/Jigsawpuzzle-demo/image/Logo-Collage.jpg',
            fullImg        : null,
            numcolumns     : 3,
            numrows        : 3,
            difficulty     : "normal",
...
function send(){
                      $.ajax({ 
                                type: "POST", 
                                url: "submit_puzzle.php", 
                                data: "time="+target+"&points="+points+"&answers="+answers, 
