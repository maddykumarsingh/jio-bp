    ...
    $.widget("ryanf.wordsearchwidget", $.ui.mouse, {
        ...
        this._cellY = cell.offset().top;
            ...
            var wordtext="";
                            ...
                            //  }
                            //  if(!wordtext==""){
                            //     // $(".Additem").text(($(".Additem").text() + ', ' + wordtext).replace(/^, /, ''));
                            //     $(".Additem").val(($(".Additem").val() + ', ' + wordtext).replace(/^, /, ''));
                            //  }
    ...
    signalWordFound : function (w) {
        ...
        $(w).css("background",'yellow').animate({"opacity": 'hide'},1000,"linear",
 			...
 			if($('.counter').val()=="10"){
                        ...
                        //  var word=$('.rf-foundword').text();
                        //  // var word2=$('.rf-ptrue').text()+ ",";
                        // console.log(word);
                        // console.log(word2);
                        // $(".content").text(word2.replace(/,/g, ","));
...
$(document).ready( function () {
    var words = "Complaints,Renewal,Checkup,Payments,Status,Requests";
