...
$getId1='SELECT t1.name as name,t1.total_score as points,t1.time as tim FROM crossword t1 where sessionId="'.$_SESSION['sessionId'].'" AND organizationId="'.$_SESSION['organizationId'].'"  order by t1.total_score desc limit 15';
...
<style>
    body{
          height: 100vh;
            width: 100%;
            background-image: linear-gradient(rgba(0, 0, 0, .4), rgba(0, 0, 0, .4)), url('images/cross-bg.jpg');
