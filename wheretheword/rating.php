...
<div class="score">Your score is <?php echo $score;?></div>
</div>
<div class="col-md-12 text-center">
<div class="btn btn-info next rate-this-game" style="margin-top:15px; width:200px;">Rate this game</div>
</div>
<div class="col-md-12">
...
<div class="col-md-6 col-md-offset-3 text-center rate">
Excellent !
</div>
...
<div class="col-md-12 text-center">
<div class="btn btn-info next submit-button" style="margin-top:15px; display:none;">Submit</div>
</div>
</div>
</div>
</div>
...
function send(){
    ...
    console.log(review);
    let token = <?php $_SESSION['token']; ?>
    $.ajax({
    url: 'http://139.59.7.187/api/game-server/review/add',
    type: 'POST',
    "timeout": 0,
    data: JSON.stringify({
                      "rating":currentRating,
                      "comments": [review],
                      "review": ratingData[currentRating-1]
                   }),
    headers: {
    ...
    error: function (error) {
        swal("Network error", "Please try again !!!", "info");
    },
             dataType: "json",
